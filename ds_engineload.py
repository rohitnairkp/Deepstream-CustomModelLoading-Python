...
trt_engine_path = os.path.join("/opt/nvidia/deepstream/deepstream-5.1/samples/models/tlt_pretrained_models/peoplenet/resnet34_peoplenet_pruned.etlt_b1_gpu0_fp32.engine")
...
image = cv2.imread("/home/rohit/Documents/Deepstream-Python/raw_images/people.jpg",cv2.IMREAD_UNCHANGED)[..., ::-1]
...
for idx in indexes:
    ...
    cv2.putText(image_cpy,str(id),(xmin, ymin), font, 2,(255,0,255),2,cv2.LINE_AA)
    cv2.imwrite('/home/rohit/Documents/Deepstream-Python/processed_images/people_processed.jpg',cv2.cvtColor(image_cpy, cv2.COLOR_RGB2BGR))

...
image = cv2.imread("/home/glueck/Documents/Deepstream-Python/raw_images/person.jpg",cv2.IMREAD_UNCHANGED)[..., ::-1]
...
for idx in indexes:
    ...
    cv2.imwrite('/home/glueck/Documents/Deepstream-Python/processed_images/image.png',cv2.cvtColor(image_cpy, cv2.COLOR_RGB2BGR))
